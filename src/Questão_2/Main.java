...
public class Main {
	public static void main(String[] args) {
		...
		Produtor produtor2 = new Produtor("Arthur Fellipe de Lira Aleixo", "arthur.fellipe@gmail.com", LocalDate.parse("2004-02-12"),"Gym", conteudoVlog);
		Produtor produtor3 = new Produtor("Nicholas Camargo Silva ", "nicholas.silva@gmail.com", LocalDate.parse("2004-08-20"),"Geek", conteudoGame);
        ...
        Midia midia3 = new Midia(LocalDateTime.now().minusDays(15), "Exploring the Cosmos of Cube", 15, "SpeedCubing", produtor1);
        Midia midia4 = new Midia(LocalDateTime.now().minusDays(7), "The Art of Cooking", 16, "Gym", produtor2);
        Midia midia5 = new Midia(LocalDateTime.now().minusDays(45), "The Power of Music on Games", 14, "Geek", produtor3);
        Midia midia6 = new Midia(LocalDateTime.now().minusDays(60), "How to Learn CFOP", 18, "SpeedCubing", produtor1);
        Midia midia7 = new Midia(LocalDateTime.now().minusDays(22), "Coding Masterclass", 15, "Geek", produtor2);
        Midia midia8 = new Midia(LocalDateTime.now().minusDays(10), "Gym Tips and Tricks", 15, "Gym", produtor3);
        ...
        System.out.println(ListagemMidiaFaixaEtaria);
        System.out.println("\r\nMidias para 14 anos:");
		for(Midia midia : ListagemMidiaFaixaEtaria) {
			System.out.println(midia.getCategoria());
		}
		
//		ArrayList<Midia> ListagemMidiaCategoria = Gabtube.listarMidiasPorCategoria("");
